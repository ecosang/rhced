...
list_temp=list.files('outputs/sample_bldg/sample/',full.names = T)
...
# 
# write_rds(df_,"outputs/sample_bldg/for_figures/df_sample.rds")
#write_rds(obs,"outputs/sample_bldg/for_figures/obs_sample.rds")
df_=read_rds("outputs/sample_bldg/for_figures/df_sample.rds")
obs=read_rds("outputs/sample_bldg/for_figures/obs_sample.rds")
library(ggplot2)
...
ggsave("outputs/figures/sample_bldg_sample_multiple_weeks.png",dpi=300,width=12,height=4)
